...
let currentPage = 0;
const memories = [
  { title: "وعدك ليا", text: "انتي وعديتي من سنتين و اتمني توفي بوعدك و تثبتيلي انك بتحبيني و احنا اتكلمنا كتير او في موضوع حجاب ونا مستني يوم ده من زمان ونا واثق انك مش هتخليني ابدا يمكن انسي اني كتبت ليكي رساله اتمني من ;ل قلبي انط نلبسي حجاب و تتوجهي ل طريق الصح ديما كان نفسي اشوفك لابساه و افرح بيكي وانتي لابسه طرحه " },
